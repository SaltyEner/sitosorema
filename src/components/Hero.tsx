    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-corporate-white px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                ...
                >
                    <div className="inline-block mb-4 px-3 py-1 bg-brand-teal/10 text-brand-teal font-semibold text-sm rounded-full tracking-wider uppercase">
                    ...
                    <h1 className="text-5xl lg:text-7xl font-serif font-bold text-navy-blue mb-6 leading-tight">
                        Sara <span className="text-brand-teal">Prosperi</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <motion.a
                            ...
                            className="group flex items-center justify-center gap-2 px-8 py-4 bg-brand-teal text-white rounded-full font-semibold hover:bg-brand-teal/90 transition-colors shadow-lg hover:shadow-brand-teal/25"
                        >
                ...
                >
                    <div className="relative w-72 h-72 lg:w-96 lg:h-96">
                        {/* Animated Rings */}
                        <div className="absolute inset-0 rounded-full border border-brand-teal/20 scale-110 animate-[spin_10s_linear_infinite]" />
                        ...
                        <motion.div
                            ...
                            className="absolute -bottom-4 -left-4 bg-white p-4 rounded-xl shadow-xl border-l-4 border-brand-teal z-20"
                        >
